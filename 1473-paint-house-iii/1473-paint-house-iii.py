...
#                     if color == last_color:
#                         ans = min(ans, findMin(i+1, last_color, n)+cost[i][color-1])
#                     else:
#                         ans = min(ans, findMin(i+1, color, n+1) + cost[i][color-1])
#                 return ans
#             else:
#                 ans = None
#                 if houses[i] == last_color:
#                     ans = findMin(i+1, last_color, n)
#                 else:
#                     ans = findMin(i+1, houses[index], n+1)
#                 return ans
#         res = findMin(0, 0, 0)
#         return res 
class Solution:
